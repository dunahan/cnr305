  ...
  while (oItem != OBJECT_INVALID)
  {
    if (GetTag(oItem) == "cnrGemMineral000")
    {
      ...
      { int nRand = Random(133)+1;
        ...
        else if ((nRand >= 33) && (nRand <= 42)) {sMineralTag = "cnrGemMineral011";}  // 10
        else if ((nRand >= 43) && (nRand <= 52)) {sMineralTag = "cnrGemMineral015";}  // 11
        else if ((nRand >= 53) && (nRand <= 64)) {sMineralTag = "cnrGemMineral003";}  // 12
        else if ((nRand >= 65) && (nRand <= 77)) {sMineralTag = "cnrGemMineral004";}  // 13
        else if ((nRand >= 78) && (nRand <= 90)) {sMineralTag = "cnrGemMineral014";}  // 13
        else if ((nRand >= 91) && (nRand <= 104)) {sMineralTag = "cnrGemMineral002";} // 14
        else if ((nRand >= 105) && (nRand <= 118)) {sMineralTag = "cnrGemMineral007";}// 14
        else {sMineralTag = "cnrGemMineral001";}                                      // 14
        //                                                                            //----
        //                                                                            //133
        object oMineral = CreateItemOnObject(sMineralTag, oUser, 1);
...
/*///////////////////////////////////////////////////////
//  Fixed cnr_minbath_ou script -- version 2, based on the actual numbers present (more lower quality gems)
//  Craftable Natural Resources (CNR) by Festyx
//
//  Name:  cnr_minbath_ou
//
